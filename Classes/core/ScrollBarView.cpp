...
#include "core/ScrollBarView.h"
#include "core/Scale9SpriteWrapper.h"
...
//    Rect insets    = Rect(1, 4, 8, 12);
    bar = Scale9SpriteWrapper::createWithSpriteFrameName("scrollbar_vertical.png", BAR_FIX_SIZE, BAR_MIN_SIZE);
...
//    Rect insets    = Rect(4, 1, 12, 8);
    bar = Scale9SpriteWrapper::createWithSpriteFrameName("scrollbar_horizontal.png", BAR_FIX_SIZE, BAR_MIN_SIZE);
