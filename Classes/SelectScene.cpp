...
{
    CCLOG("name = %s", pSelectorName);
    CCB_SELECTORRESOLVER_CCCONTROL_GLUE(this, "tappedStartButton", SelectScene::tappedStartButton);
    return NULL;
}

void SelectScene::tappedStartButton(Ref* pTarget, Control::EventType pControlEventType)
{
